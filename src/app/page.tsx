...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black stars-bg">
      <Stars/>
      <main className="w-full max-w-3xl flex-col text-center py-32 px-16 bg-white dark:bg-black sm:items-start text-black dark:text-white z-1">
      ...
      <Image src="./mitsuru-w.png" width={300} height={300} alt="Dibujo de Kirijo Mitsuru" unoptimized className='fixed right-20'/>
    </div>
  );
}
